  ...
  return (
    <div className="text-center text-white">
      <div className="max-w-md mx-auto space-y-6">
        {/* Divider Ampersand (&) sesuai screenshot */}
        <div className="flex items-center justify-center gap-4 py-2 opacity-60">
          <div className="h-[1px] w-24 bg-gradient-to-r from-transparent to-stone-400" />
          <span className="font-serif italic text-2xl text-stone-300">&</span>
          <div className="h-[1px] w-24 bg-gradient-to-l from-transparent to-stone-400" />
        </div>

        {/* Title */}
        <h2 className="text-xs sm:text-sm uppercase tracking-[0.35em] text-stone-300 font-sans font-light">
          THE BRIDE
        </h2>

        {/* Card Frame Foto */}
        <div className="relative mx-auto w-full max-w-[240px] sm:max-w-[280px] aspect-[3/4] rounded-2xl overflow-hidden shadow-2xl border border-white/10">
